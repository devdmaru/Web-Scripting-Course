    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {              
                ...
                String url = "jdbc:mysql://localhost:3307/fa16_4350_tuf37373?user=tuf37373&password=eezibiej";
                
                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/fa16_4350_tuf37373?user=tuf37373&password=eezibiej";  
                }                 
